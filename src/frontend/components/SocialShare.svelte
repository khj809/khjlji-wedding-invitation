<script>
  const url = "https://khjlji-wedding-invitation.vercel.app/";
  ...
  <ul class="share-wrap">
    ...
    <li>
      <button class="share-kakao" on:click={shareKakaoLink}>
        <img src="//developers.kakao.com/assets/img/about/logos/kakaolink/kakaolink_btn_medium.png" alt="카카오톡" />
      </button>
    </li>
    <li>
      <button class="share-kakaostory" on:click={shareKakaoStory}>
        <img src="https://developers.kakao.com/sdk/js/resources/story/icon_small.png" alt="카카오스토리로 공유하기" />
      </button>
    </li>
  </ul>
</div>
